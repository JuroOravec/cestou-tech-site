...
const remoteSiteUrl = 'https://cestou.tech';
...
export const metadata: GridsomeConfigMetadata = {
  ...
  siteImage: {
    image: `${cwd}/static/imgs/cestou-tech-logo.png`,
    url: formatUrlFromStaticPath(siteUrl, './static/imgs/cestou-tech-logo.png'), // prettier-ignore
    alt: 'Cestou Tech',
  },
  siteCopyright: 'Všetky práva vyhradené, Cestou Tech',
  siteLastUpdated: new Date('2022-04-01'),
  /**
  ...
  icon: {
    favicon: {
      png: `${cwd}/static/imgs/cestou-tech-logo-notext.png`,
      svg: `${cwd}/static/imgs/cestou-tech-logo-notext.svg`,
    },
    touchicon: `${cwd}/static/imgs/cestou-tech-logo-notext.png`,
    maskColor: '#666600',
  },
  social: {
  ...
  comments: {
    ...
    vssueGithubRepo: 'cestou-tech-site',
